-- Owner create-car RPC to avoid recursive RLS/policy issues on direct inserts.
-- This keeps the current owner create-car flow unchanged while moving the write
-- into a security definer function that validates role once and performs both
-- inserts atomically.
